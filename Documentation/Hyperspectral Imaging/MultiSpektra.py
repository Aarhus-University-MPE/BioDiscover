...
chanal = 290 #Channal to visualize approx 1,42*chanal+513 nm | 
...
#Figure showing an average spectrum
#plt.figure() #Initilaization of the figure
axis_l = np.arange(900)*1.4234+513.1      #creating band-wavelength table
delta=5
...
plt.title("Collected Spectrum of dish 7", color = 'k')
plt.xlabel("Wavelength")
plt.ylabel("Intensity")
#plt.close() #Comment this out if you wish to see the collected spectrum
...
plt.xlabel("Wavelength")
plt.ylabel("Intensity")
plt.close()  #Comment this out if you wish to see the specific spectrum of something
